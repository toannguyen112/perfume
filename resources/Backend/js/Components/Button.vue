...
export default {
  ...
  computed: {
    buttonClass() {
      const variant = {
        primary:
          "text-white bg-primary hover:bg-primary-darker active:bg-primary-600",
        "outline-primary":
        ...
        success:
          "text-green-600 bg-green-300 hover:bg-green-400 hover:text-green-700",

        "link-danger": "bg-transparent text-red-600 hover:underline px-0 py-0",
      }[this.variant];

      const size = {
        xxs: "text-[9px] h-[1rem] px-1",
