...
export default {
  ...
  computed: {
    selectLabelField() {
      return this.field.config && this.field.config.label
        ? this.field.config.label
        : "label";
    },

    selectTrackByField() {
      return this.field.config && this.field.config.trackBy
        ? this.field.config.trackBy
        : "id";
    },
    ...
    selectedOptions() {
      ...
      return this.field.options.filter((x) =>
        defaultValue.includes(x[this.selectTrackByField].toString())
      );
    },
  },
