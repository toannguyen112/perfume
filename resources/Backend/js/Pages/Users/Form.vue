<template>
  <Form :form="form" :rules="rules" :hide-action="true">
    ...
    <!-- <div class="mt-10 space-y-6 bg-white rounded">
            <table class="table">
                <tr>
                    <th>Mã hồ sơ</th>
                    <th>Trạng thái</th>
                    <th>Thời gian công chứng</th>
                    <th>Ngày tạo</th>
                    <th></th>
                </tr>
                <tr v-for="(document, index) in item.documents">
                    <td>
                        <Link
