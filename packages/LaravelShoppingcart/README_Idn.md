...
| Exception                    | Reason                                                                                    |
| ---------------------------- | ----------------------------------------------------------------------------------------- |
| _CartAlreadyStoredException_ | Saat mencoba menyimpan keranjang yang sudah disimpan menggunakan pengenal yang ditentukan |
| _InvalidRowIDException_      | Ketika rowId yang diteruskan tidak ada dalam instance troli saat ini                      |
| _UnknownModelException_      | Saat Anda mencoba mengaitkan model yang tidak ada dengan Item Keranjang.                  |
